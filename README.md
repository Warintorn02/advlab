...
วัตถุประสงค์ :
- เป็นการดาวน์โหลดวิดีโอจากเว็บไซต์ YouTube มาเก็บไว้ในคอมพิวเตอร์
- ใช้ตัวของไลบรารี yt-dlp ซึ่งเป็นเครื่องมือในการดาวโหลอด
    
ที่ต้องทำ :
- การติดตั้งในตัวของ yt-dlp ให้ใช้คำสั่ง : pip install yt-dlp
- ทำการเชื่อมต่ออินเทอร์เน็ต

การทำงาน :
    1. รับ URL ของวิดีโอ YouTube จากผู้ใช้
    2. สร้างการตั้งค่าสำหรับการดาวน์โหลด
    3. ดาวน์โหลดวิดีโอในเวอร์ชั่นที่ดีที่สุดของคริป
    4. บันทึกไฟล์ด้วยชื่อของวิดีโอของต้นฉบับ
